...
public class IAPListener implements OnPurchaseListener {
	...
	public void onBillingFinish(String code, HashMap arg1) {
		...
		if (code.compareTo(PurchaseCode.BILL_ORDER_OK) == 0
				|| (code.compareTo(PurchaseCode.AUTH_OK) == 0)
				|| (code.compareTo(PurchaseCode.WEAK_ORDER_OK) == 0)) {
			/**
			...
			if (arg1 != null) {
                ...
                validateOrderMM(paycode, orderID, tradeID, 0);
    ...
    private native void validateOrderMM(String payCode, String tradeID, String orderID, int options);
